...
#define SPP_SERVER_NAME "SMART_WATCH_BT_SERVER"
#define EXAMPLE_DEVICE_NAME "SMART_WATCH_VT"
...
void esp_spp_cb(esp_spp_cb_event_t event, esp_spp_cb_param_t *param)
{
    ...
    case ESP_SPP_DATA_IND_EVT:
        ESP_LOGI(SPP_TAG, "ESP_SPP_DATA_IND_EVT len:%i handle:%i", (int)param->data_ind.len, (int)param->data_ind.handle);
